      ...
      <div className={`flex flex-wrap gap-[15px] cursor-default`}>
        ...
        >
          ...
          <div className="h-[40%] mt-[10px] bg-[#172a45] antialiased text-[17px] text-[#a8b2d1] font-calibri leading-[1.3] opScreen7:h-[35%] opScreen12:mt-[20px] opScreen13:h-[30%] opScreen16:mt-[30px] opScreen17:h-[44%] opScreen20:h-[50%]">
            ...
            manage their tasks, set reminders, and prioritize them efficiently.
          </div>
          {/* Footer */}
        ...
        >
          ...
          {/* Description */}
          <div className="h-[40%] mt-[10px] bg-[#172a45] antialiased text-[17px] text-[#a8b2d1] font-calibri leading-[1.3] opScreen5:h-[37%] opScreen6:h-[40%] opScreen7:h-[35%] opScreen13:h-[30%] opScreen16:mt-[30px] opScreen17:h-[44%]">
            This shopping summary app is a user-friendly app that sells a static
            product and accepts discount coupons.
          </div>
          {/* Footer */}
          <div className="h-[15%] mt-[10px] text-[#8892b0] text-[12px] font-calibri items-center bg-[#172a45] flex opScreen5:mt-[29px] opScreen6:h-[11.7%] opScreen9:h-[15%] opScreen13:h-[22%] opScreen13:items-center opScreen14:mt-[15px] opScreen16:h-[6%] opScreen16:mt-[40px] opScreen17:mt-[20px] opScreen19:mt-[33px] opScreen21:h-[12%] opScreen25:mt-[24px] opScreen28:mt-[33px] opScreen30:mt-[36px] opScreen31:mt-[29px]">
            HTML, CSS, Tailwind, JavaScript, React, Context_Api
          </div>
        </div>
        {/* Fourth Project Box */}
        <div
        ...
        >
          ...
          <div className="h-[40%] mt-[10px] bg-[#172a45] antialiased text-[17px] text-[#a8b2d1] font-calibri leading-[1.3] opScreen1:h-[45%] opScreen5:h-[37%] opScreen6:h-[39%] opScreen7:h-[37%] opScreen13:h-[30%] opScreen16:mt-[30px] opScreen17:h-[44%] opScreen23:h-[48%]">
            An official US Mircosoft website clone featuring full responsiveness
            and all the necessary front-end functionality.
          </div>
          {/* Footer */}
          <div className="h-[13%] mt-[10px] text-[#8892b0] text-[12px] font-calibri bg-[#172a45] flex items-center opScreen5:mt-[20px] opScreen6:h-[13%] opScreen6:mt-[18px] opScreen13:h-[22%] opScreen13:items-center opScreen14:mt-[15px] opScreen16:h-[6%] opScreen16:mt-[40px] opScreen17:mt-[20px] opScreen19:mt-[30px] opScreen25:mt-[22px]">
        ...
        >
          ...
          <div className="w-[100%] h-10 bg-[#172a45] flex justify-between items-center">
            ...
            >
              <a
                href="https://github.com/Abdullah-9862873/Facebook-Frontend-Clone"
                aria-label="GitHub Link"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="h-[40%] mt-[10px] bg-[#172a45] antialiased text-[17px] text-[#a8b2d1] font-calibri leading-[1.3] opScreen6:h-[30%] opScreen7:h-[35%] opScreen13:h-[30%] opScreen16:mt-[20px] opScreen17:h-[38%] opScreen25:h-[35%] opScreen29:h-[25%] opScreen30:h-[37%]">
            Facebook's sign-up page's clone, fully responsive and with all
        ...
        >
          ...
          <div className="w-[100%] h-10 bg-[#172a45] flex justify-between items-center">
            ...
            >
              <a
                href="https://github.com/Abdullah-9862873/Shopping_Cart_Redux"
                aria-label="GitHub Link"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="h-[40%] mt-[10px] bg-[#172a45] antialiased text-[17px] text-[#a8b2d1] font-calibri leading-[1.3] opScreen6:h-[40%] opScreen7:h-[35%] opScreen13:h-[30%] opScreen16:mt-[30px] opScreen17:h-[44%] opScreen24:h-[49%] opScreen25:h-[44%] opScreen29:h-[33%] opScreen30:h-[40%]">
            A redux based shopping cart with all necessary features for a
          ...
          <div className="h-[13%] mt-[10px] text-[#8892b0] text-[12px] font-calibri bg-[#172a45] flex items-center opScreen4:mt-[5px] opScreen6:h-[13%] opScreen6:mt-[22px] opScreen7:h-[11%] opScreen9:h-[6%%] opScreen12:mt-[25px] opScreen13:h-[20%] opScreen13:items-center opScreen13:mt-[5px] opScreen14:mt-[15px] opScreen16:h-[6%] opScreen16:mt-[40px] opScreen17:mt-[20px] opScreen26:mt-[23px] opScreen27:mt-[14px] opScreen30:mt-[17.6px]">
            HTML, CSS, JavaScript, React, Redux_ToolKit
          </div>
        </div>
        {/* Seventh Project Box */}
        {showMoreBtnClicked && (
          ...
          >
            ...
            <div className="w-[100%] h-10 bg-[#172a45] flex justify-between items-center">
              ...
              >
                <a
                  href="https://github.com/Abdullah-9862873/City_Tours_App"
                  aria-label="GitHub Link"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="h-[40%] mt-[10px] bg-[#172a45] antialiased text-[17px] text-[#a8b2d1] font-calibri leading-[1.3] opScreen5:h-[45%] opScreen6:h-[40%] opScreen7:h-[35%] opScreen13:h-[30%] opScreen16:mt-[30px] opScreen17:h-[44%] opScreen20:h-[50%] ">
              The app provides a guide to the top destinations in various
              cities, including information on how to visit and notable sights
              to see.
            </div>
            {/* Footer */}
